...
function PLPContestCard2({ data }: Props) {
  ...
  const loadTimer = () => {
    ...
    if (currentTime > startTime && currentTime < endTime) {
      ...
      return (
        <div className="font-lodrian tracking-wider text-[38px] text-white justify-center m-auto flex bg-red-500">
          Event Ended
        </div>
      );
    } else {
      return (
        <div className="font-lodrian tracking-wider text-[38px] text-white justify-center m-auto flex ">
          Coming Soon
        </div>
      );
    }
    ...
    >
      <div className="!flex mx-8 mt-[30px] lg:mx-16  2xl:mx-0 flex-col  md:flex-row  md:relative w-full md:h-[300] lg:h-[638px]">
        ...
        >
          ...
          <div
            className={`w-full h-[400px] md:h-[638px] flex justify-center ml-auto  items-center`}
          >
            <div className="w-full  md:h-[381px]  md:mt-[86px]  flex flex-col items-center lg:items-end  justify-center m-auto">
              <div
                className={cn(
                  " w-[90%] md:w-1/2  flex justify-end flex-col transition-all duration-500",
                  {
                    "md:w-full": clickTwo === true,
                  }
                )}
              >
                <div className=" justify-around h-[400px] flex flex-col items-end ">
        ...
        <div
          className={`w-full  md:w-[50%] h-fit md:h-[638px] rounded-b-[20px] md:rounded-l-none md:absolute md:right-0 bg-[#33455A] mr-auto  items-center ${
        ...
        >
          <div className="flex w-full justify-center align-middle items-center flex-col  h-full">
            <div className="w-full  py-4 px-16 lg:px-2 lg:py-3    flex-wrap items-center flex-col md:flex-row gap-5  md:w-[220px] lg:w-[330px] lg:min-h-[200px] 2xl:w-[450px] 2xl:min-h-[276px] m-auto md:justify-center text-justify font-normal  font-avenirThin  2xl:text-[24px] md:text-xs lg:text-sm xl:text-base 2xl:leading-[28.8px] text-white">
              <div className="flex mt-5"> {Intro}</div>

              <div className="flex justify-center  items-center   md:space-x-4 my-8 md:my-4 flex-col md:flex-row  m-auto">
                {buttons?.map((button) => (
...
export default PLPContestCard2;

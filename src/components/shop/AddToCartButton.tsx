...
import { LucideTrash2, Minus, Plus, ShoppingBag } from "lucide-react";
...
const AddToCartButton = ({ item }: Props) => {
  ...
  return (
    <Sheet>
      <SheetTrigger onClick={addToCartHandler}>
        <div className="border-4 !w-[167.82px] !h-[33.03px] text-[12.8px] flex items-center justify-center lg:!w-[111.88px] lg:!h-[22.02px] xl:w-[139.85px] xl:!h-[27.52px] 2xl:!w-[167.82px] 2xl:!h-[33.03px] lg:text-[8.53px] lg:rounded-[4.27px] lg:border-[2.13px] xl:text-[10.6px] 2xl:text-[12.8px] xl:border-[2.67px] bg-[#33455A] border-[#FFC52E] rounded-[8px] text-[#FFC52E] font-avenirThin hover:bg-[#FFC52E] hover:border-[#33455A] hover:text-[#33455A]">
          Add to Cart
        </div>
      </SheetTrigger>
                  ...
                  >
                    <div className="relative flex w-full flex-row justify-between px-1 py-4">
                      ...
                      <div className="flex h-16 flex-col justify-between">
                        ...
                        <div className="ml-auto mt-2 flex h-9 gap-2 md:gap-3 flex-row items-center rounded-full border border-neutral-200 dark:border-neutral-700">
                          <Minus
